...
csv_file_path = r'C:\Users\pavan\Downloads\Compressed\flipkart-grid-5-main\flipkart-grid-5-main\backend\dataset\user_history_data\john.csv'  # Replace with the actual path to your CSV file
